...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("hand")
    .setDescription("Пожать руку пользователю")
  ...
  async execute(interaction, client) {
    ...
    const gifs = settingSchema.gifs.handGifs;
    ...
    await interaction.reply({
      embeds: [
        new EmbedBuilder()
          .setTitle("Реакция - рукопожатие")
          .setDescription(`${interaction.user} пожал руку ${user}!`)
